...
public class Main {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        File folder = new File("C:\\Users\\Temporary\\Desktop\\Lab Notes Object");
        ...
        while(true)
        {
            ...
            if(input==1)
            {
                ...
                Note note=new Note();
                note.text=text;
                FileOutputStream f = new FileOutputStream(new File("C:\\Users\\Temporary\\Desktop\\Lab Notes Object\\"+folderName));
            ...
            else if(input==2)
            {
                ...
                else if(input2==2)
                {
                    ...
                    ObjectInputStream objectInputStream =
                            new ObjectInputStream(new FileInputStream("C:\\Users\\Temporary\\Desktop\\Lab Notes Object\\"+listOfFiles[index].getName()));
                    Note note = (Note) objectInputStream.readObject();
                    objectInputStream.close();
                    note.text= note.text+text;
                    FileOutputStream f = new FileOutputStream(new File("C:\\Users\\Temporary\\Desktop\\Lab Notes Object"+listOfFiles[index].getName()));
                    ObjectOutputStream o = new ObjectOutputStream(f);
                    o.writeObject(note);
                    o.close();
                    f.close();
